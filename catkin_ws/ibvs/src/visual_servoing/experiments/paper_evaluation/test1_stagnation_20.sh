...
# TEST1 - STAGNATION 20: Hollywood 500 evaluation with 20 iteration stagnation window
# - Feature stagnation: 20 iterations at 0.5px
# - Tiling switch: 0.8 (20% of initial error)
...
echo "========================================================================="
echo "TEST1 - STAGNATION 20: Hollywood 500 Evaluation - 20 Iteration Window"
echo "========================================================================="
echo "Samples per method: $SAMPLES"
echo "Feature stagnation: 20 iterations at 0.5px"
echo "Tiling switch: 0.8 (20% of initial error)"
echo ""
...
RESULT_DIR="${SCRIPT_DIR}/results/test1_stagnation_20/${TIMESTAMP}"
mkdir -p ${RESULT_DIR}

# Save experiment metadata
cat > ${RESULT_DIR}/experiment_info.txt << EOF
TEST1 - STAGNATION 20: Hollywood 500 - 20 Iteration Stagnation Window
Date: $(date)
Samples: $SAMPLES
...
Feature Stagnation: Enabled (20 iterations at 0.5px)
Tiling Switch: 0.8 (20% of initial error)
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_stagnation_20/config_dinov2_308_no_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_stagnation_20/config_dinov2_518_no_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
echo ""
echo "=================================================="
echo "[3/9] Running DINOv2-224 (7x7 tiling)..."
echo "=================================================="
mkdir -p ${RESULT_DIR}/dinov2_224_7x7
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_stagnation_20/config_dinov2_224_7x7_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
    --output ${RESULT_DIR}/dinov2_224_7x7/results_dinov2_224_7x7_model99.npz \
    --iteration-display-freq 50

# Method 4: DINOv3-256 (6x6 tiling)
echo ""
echo "=================================================="
echo "[4/9] Running DINOv3-256 (6x6 tiling)..."
echo "=================================================="
mkdir -p ${RESULT_DIR}/dinov3_256_6x6
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_stagnation_20/config_dinov3_256_6x6_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_stagnation_20/config_dinov3_1440_no_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
    --output ${RESULT_DIR}/dinov3_1440_no_tiling/results_dinov3_1440_model99.npz \
    --iteration-display-freq 50

# Method 6: AM-RADIO-256 (6x6 tiling)
echo ""
echo "=================================================="
echo "[6/9] Running AM-RADIO-256 (6x6 tiling)..."
echo "=================================================="
mkdir -p ${RESULT_DIR}/amradio_256_6x6
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_stagnation_20/config_amradio_256_6x6_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_stagnation_20/config_sift_hollywood_500.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_stagnation_20/config_orb_hollywood_500.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_stagnation_20/config_akaze_hollywood_500.yaml \
    --models 99 \
    --samples ${SAMPLES} \
