...
# TEST1 - CURRENT: Hollywood 500 evaluation with CURRENT settings
...
echo "============================================================"
echo "TEST1 - CURRENT: Hollywood 500 Evaluation - Current Settings"
echo "============================================================"
...
RESULT_DIR="${SCRIPT_DIR}/results/test1_current/${TIMESTAMP}"
mkdir -p ${RESULT_DIR}

# Save experiment metadata
cat > ${RESULT_DIR}/experiment_info.txt << EOF
TEST1 - CURRENT: Hollywood 500 - Current Settings
Date: $(date)
Samples: $SAMPLES
