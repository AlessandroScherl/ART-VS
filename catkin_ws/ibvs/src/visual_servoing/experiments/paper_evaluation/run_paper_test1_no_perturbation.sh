...
# TEST1: Hollywood 500 evaluation without perturbation
...
echo "=================================================="
echo "TEST1: Hollywood 500 Evaluation - No Perturbation"
echo "=================================================="
...
RESULT_DIR="${SCRIPT_DIR}/results/test1_no_perturbation/${TIMESTAMP}"
mkdir -p ${RESULT_DIR}

# Save experiment metadata
cat > ${RESULT_DIR}/experiment_info.txt << EOF
TEST1: Hollywood 500 - No Perturbation
Date: $(date)
Samples: $SAMPLES
...
echo ""
echo "=================================================="
echo "[1/10] Running DINOv2-308 (no tiling)..."
echo "=================================================="
...
echo ""
echo "=================================================="
echo "[2/10] Running DINOv2-518 (no tiling)..."
echo "=================================================="
...
echo ""
echo "=================================================="
echo "[3/10] Running DINOv2-224 (7x7 tiling)..."
echo "=================================================="
...
echo ""
echo "=================================================="
echo "[5/10] Running DINOv3-256 (6x6 tiling)..."
echo "=================================================="
...
# Method 5: DINOv3-1440 (no tiling - MODE 1)
echo ""
echo "=================================================="
echo "[6/10] Running DINOv3-1440 (no tiling)..."
echo "=================================================="
...
echo ""
echo "=================================================="
echo "[7/10] Running AM-RADIO-256 (6x6 tiling)..."
echo "=================================================="
...
echo "  python3 ../visualize_benchmark.py ${RESULT_DIR}/*/results_*.npz --comparison"
