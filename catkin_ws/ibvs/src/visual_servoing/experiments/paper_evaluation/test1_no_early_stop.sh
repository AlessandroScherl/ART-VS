...
# TEST1 - NO EARLY STOP: Hollywood 500 evaluation with DISABLED feature stagnation
# - Feature stagnation: DISABLED (run full 1500 iterations)
...
echo "========================================================================="
echo "TEST1 - NO EARLY STOP: Hollywood 500 Evaluation - No Feature Stagnation"
echo "========================================================================="
echo "Samples per method: $SAMPLES"
echo "Feature stagnation: DISABLED (full iterations)"
...
RESULT_DIR="${SCRIPT_DIR}/results/test1_no_early_stop/${TIMESTAMP}"
mkdir -p ${RESULT_DIR}

# Save experiment metadata
cat > ${RESULT_DIR}/experiment_info.txt << EOF
TEST1 - NO EARLY STOP: Hollywood 500 - No Feature Stagnation
Date: $(date)
Samples: $SAMPLES
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_no_early_stop/config_dinov2_308_no_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_no_early_stop/config_dinov2_518_no_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_no_early_stop/config_dinov2_224_7x7_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_no_early_stop/config_dinov3_256_6x6_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_no_early_stop/config_dinov3_1440_no_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_no_early_stop/config_amradio_256_6x6_tiling.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_no_early_stop/config_sift_hollywood_500.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_no_early_stop/config_orb_hollywood_500.yaml \
    --models 99 \
    --samples ${SAMPLES} \
...
python3 run_multi_model_experiment_with_hollywood.py \
    --config ../../configs/test1_no_early_stop/config_akaze_hollywood_500.yaml \
    --models 99 \
    --samples ${SAMPLES} \
